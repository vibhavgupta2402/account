...
export default function PurchaseOrder() {
  ...
  const [purorDate, setPurorDate] = useState(new Date()); 
  const [purordisDate, setPurordisDate] = useState(new Date()); 
  const [porNo, setPorNo] = useState("");
